...
#define monoTable_totalSize 275 //>index of term[max(deg_y)][w] in the pole basis + 1, nearly equals to tg_size
//polebasis()
...
#define faiMax_Ysize 10	//change with diff w and k, the max degY of probably used polebasis(polebasis_k-1)
#define faiMax_Xsize 4	//change with diff w and k, the max degX of probably used polebasis(polebasis_k-1)
