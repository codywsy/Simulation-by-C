...
#define monoTable_totalSize 24948 //>index of term[max(deg_y)][w] in the pole basis + 1, nearly equals to tg_size
//*******************
...
//			message[0]=0;	message[1]=0;	message[2]=0;	message[3]=0;
			...
			printf("Progress=%0.1f, SNR=%2.2f, aver_iterNum=%0.2f, Max_iterNum=%d, Max_m=%d\r", progress, SNR, aver_iterNum, Max_iterNum, Max_m);

		}

		printf("Progress=%0.1f, SNR=%2.2f, aver_iterNum=%0.2f, Max_iterNum=%d, Max_m=%d\n", progress, SNR, aver_iterNum, Max_iterNum, Max_m);

		OpenFile;
		fprintf(fp,"Progress=%0.1f, SNR=%2.2f, aver_iterNum=%0.2f, Max_iterNum=%d, Max_m=%d\n", progress, SNR, aver_iterNum, Max_iterNum, Max_m);
		fclose(fp);
