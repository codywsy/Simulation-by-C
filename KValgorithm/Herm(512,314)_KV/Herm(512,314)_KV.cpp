...
//rcs()
#define rcspoly_Ysize 2783	//degY+1, degY = interpoly_Ysize + max(j_1) + w*( (max(i_1)+w)/(w+1) ), rcspoly_Ysize = (expoly_Ysize-1) + (facpoly_Ysize-1) + 1
...
//polebasis
#define faiMax_Ysize 38	//change with diff w and k, the max degY of probably used polebasis
