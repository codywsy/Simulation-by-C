...
#define myWay
#define OpenFile fp=fopen("Herm(64,29)_KV_l=2.txt","a")
...
//rcs()
#define rcspoly_Ysize 174	//degY+1, degY = interpoly_Ysize + max(j_1) + w*( (max(i_1)+w)/(w+1) ), rcspoly_Ysize = (expoly_Ysize-1) + (facpoly_Ysize-1) + 1
