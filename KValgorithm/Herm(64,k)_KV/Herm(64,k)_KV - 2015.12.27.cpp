...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("Herm(64,29)_KV_l=1.txt","a"))==NULL)
	{
...
//			test_vec_contruction();
		...
		fp=fopen("Herm(64,29)_KV_l=1.txt","a");
			...
			if(	zb_temp1[j]!=0 )
			{
				...
				while( index_flag>w )
				{
					...
					for(u=0;u<zb_Ysize;u++)
						...
						{
//							poly_temp1[u+1][temp] = add( poly_temp1[u+1][0],poly_temp1[u][index_flag] );	//y^1
//							poly_temp1[u+w][temp] = add( poly_temp1[u+w][0],poly_temp1[u][index_flag] );	//y^2
