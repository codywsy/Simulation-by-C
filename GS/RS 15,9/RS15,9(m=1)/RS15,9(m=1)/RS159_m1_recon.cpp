...
#define poly_Xsize 17 // C+1 approximately 
...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("GS(15,11)m=1.txt","a"))==NULL)
	{
...
/*			//******debug*******
			message[0]=8;	message[1]=11;	message[2]=14;	message[3]=15;
			message[4]=7;	message[5]=3;	message[6]=5;	message[7]=3;
			message[8]=1;
...
/*	//*******debug**************
	rx_codeword[0]=9;	rx_codeword[1]=0;	rx_codeword[2]=2;	rx_codeword[3]=12;	rx_codeword[4]=15;	rx_codeword[5]=4;
	rx_codeword[6]=2;	rx_codeword[7]=12;	rx_codeword[8]=0;	rx_codeword[9]=8;	rx_codeword[10]=7;	rx_codeword[11]=2;
	rx_codeword[12]=14;	rx_codeword[13]=6;	rx_codeword[14]=1;
*/	//**************************
...
/*	for(j=0;j<poly_Ysize;j++)
	...
	Q[0][0][0]=11;	Q[0][0][1]=2;	Q[0][0][2]=11;	Q[0][0][3]=15;	Q[0][0][4]=14;	Q[0][0][5]=13;	Q[0][0][6]=4;
	Q[0][0][7]=4;	Q[0][0][8]=11;	Q[0][0][9]=12;	Q[0][0][10]=10;	Q[0][0][11]=3;
	
	Q[0][1][0]=9;	Q[0][1][1]=2;	Q[0][1][2]=10;	Q[0][1][3]=1;
*/
/*	//*********debug**************
	printf("\ninter_poly_minlod=\n");
	for(j=0;j<poly_Ysize;j++)
...
void choose_correct_dec_codeword(void)
{
	...
	//calculate the ferror
	for(i=0;i<n;i++)
		dec_nonbin_codeword[i]=reEncode_codeword[i];
