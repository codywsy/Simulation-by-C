/*******************************
(31,15) m=31 simulation programme
...
#define m 31 // zero of multiplicity
#define iter_num 15376  // C
#define tm 10
#define lm 31 //Desgined factorization output list size   (should be mended)
//********************************
...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("data_(31,15)m=31.txt","a"))==NULL)
	{
...
//		printf(" Progress=%0.1f,dectect=%d\r",progress,dectec);
		fp=fopen("data_(31,15)m=31.txt","a");
