/*******************************
(63,31) m=13 simulation programme
...
#define m 13 // zero of multiplicity
#define iter_num 5733  // C
#define tm 19
#define lm 19 //Desgined factorization output list size   (should be mended)
//********************************
...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("data_(63,31)m=13.txt","a"))==NULL)
	{
...
//		printf(" Progress=%0.1f,dectect=%d\r",progress,dectec);
		fp=fopen("data_(63,31)m=13.txt","a");
