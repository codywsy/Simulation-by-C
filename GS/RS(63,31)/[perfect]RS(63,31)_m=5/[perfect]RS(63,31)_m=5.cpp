/*******************************
(63,31) m=5 simulation programme
...
#define m 5 // zero of multiplicity
#define iter_num 945  // C
#define tm 18
#define lm 7 //Desgined factorization output list size   (should be mended)
//********************************
