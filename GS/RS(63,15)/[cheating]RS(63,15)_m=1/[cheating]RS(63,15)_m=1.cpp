/*******************************
(63,15) m=1 simulation programme
...
#define tm 27
#define lm 2 //Desgined factorization output list size   (should be mended)
#define poly_Ysize 3  // Ysize==lm+1
#define poly_Xsize 64 // C+1 approximately 
