/*******************************
(63,15) m=26 simulation programme
...
#define m 26 // zero of multiplicity
#define iter_num 22113  // C
#define tm 33
#define lm 55 //Desgined factorization output list size   (should be mended)
//********************************
