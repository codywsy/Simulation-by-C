...
#define mono_ordinSize 4975	//choose the value with debugging, equals to max weigtdegree in weight[monoTable_Zsize][weight_XYsize]
...
#define eta_min 1
#define eta_max 5
#define test_vec_num_max 32	//the num of test_vec is 2^eta
#define r_thread 0
...
//#define OpenFile fp=fopen("[FacCheating]New-LCC_Herm(512£¬409)_¦Ç=1_thread=0.1.txt","a")
#define OpenFile fp=fopen("[FacCheating]LCC_Herm(512£¬409)_¦Ç=5.txt","a")
#define FrameError 200

//#define _PrintGroupLod_
//#define _PrintLCCLod_
//#define _PrintGammaValue_
#define _PrintComplexity_
#define CoefficientDelta
