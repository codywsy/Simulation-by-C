...
//#define OpenFile fp=fopen("[FacCheating]New-LCC_Herm(512£¬289)_¦Ç=1_thread=0.1.txt","a")
#define OpenFile fp=fopen("[FacCheating]LCC_Herm(512£¬289)_¦Ç=1.txt","a")
