...
//int Q_uncom_elem[test_vec_num_max][init_polyNum][interpoly_Zsize][interpoly_Ysize][interpoly_Xsize];int Q_uncom_elem[test_vec_num_max][init_polyNum][interpoly_Zsize][interpoly_Ysize][interpoly_Xsize];
...
//			message[0]=1;	message[1]=2;	message[2]=1;	message[3]=3;
			...
			////debug: output a (512,289) Hermitian code
			//FILE *fout1; 
