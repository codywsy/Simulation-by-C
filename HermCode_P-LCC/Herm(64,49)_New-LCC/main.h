...
#define eta_min 1
#define eta_max 3
#define test_vec_num_max 8	//the num of test_vec is 2^eta
#define r_thread 0.9
...
#define OpenFile fp=fopen("[1,3]New-LCC_Herm(64£¬49)thread=0.9.txt","a")
//#define OpenFile fp=fopen("LCC_Herm(64£¬49)_¦Ç=1.txt","a")
