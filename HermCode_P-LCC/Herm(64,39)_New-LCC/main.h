...
#define eta_min 1
#define eta_max 12
#define test_vec_num_max 4096	//the num of test_vec is 2^eta
#define r_thread 0
...
//#define OpenFile fp=fopen("[1,5]New-LCC_Herm(64£¬39)_thread=0.4.txt","a")
#define OpenFile fp=fopen("[cheating]LCC_Herm(64,39)_¦Ç=12.txt","a")

//#define _PrintGroupLod_
//#define _PrintLCCLod_
//#define _PrintGammaValue_
//#define _PrintVariableEta_
