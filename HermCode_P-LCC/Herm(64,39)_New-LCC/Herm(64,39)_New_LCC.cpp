...
#ifdef _PrintVariableEta_
	//VariableEta
	float case1, case2, case3;
	float case1_ratio, case2_ratio, case3_ratio;
#endif
	//*******************
...
#ifdef _PrintVariableEta_
		int case_total = (int)(case1 + case2 + case3);
		if (case_total == FrameError)
		{
			case1_ratio = (case1) / case_total;
			case2_ratio = (case2) / case_total;
			case3_ratio = (case3) / case_total;
		}
		else
			printf("\n VariableEta count error!!");

		FILE* fCaseOut = fopen("CaseCount.txt", "a");
		fprintf(fCaseOut, "SNR = %2.2f,\tcase1 = %3.2f,\tcase2 = %3.2f,\tcase3 = %3.2f,\n", SNR, case1_ratio * 100, case2_ratio * 100, case3_ratio * 100);
		fclose(fCaseOut);
