...
#define eta_min 1
#define eta_max 10
#define test_vec_num_max 1024	//the num of test_vec is 2^eta
#define r_thread 0.9
...
#define OpenFile fp=fopen("[10]New-LCC_Herm(64£¬49)thread=0.9.txt","a")
//#define OpenFile fp=fopen("LCC_Herm(64£¬49)_¦Ç=10.txt","a")
//#define OpenFile fp=fopen("[3parts]LCC_Herm(64,49)_GS.txt","a")
