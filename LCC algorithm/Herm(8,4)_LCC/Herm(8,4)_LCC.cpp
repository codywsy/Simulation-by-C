...
#define able_correct 1	//GS(m=1) decoding ability ((n-k)/2)
#define pointNum 2
#define interval 1
...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("LCC_Herm(8,4)_GS.txt","a"))==NULL)
	{
...
//			message[0]=0;	message[1]=0;	message[2]=0;	message[3]=0;
		...
		fp=fopen("LCC_Herm(8,4)_GS.txt","a");
...
/*	j=0;
	for(i=0;i<n;i++)
		if(i!=2)
		{
			com_elem_interpoint[0][j] = point[0][i];
			com_elem_interpoint[1][j] = point[1][i];
			j++;
		}

	com_elem_interpoint[0][j] = point[0][2];
	com_elem_interpoint[1][j] = point[1][2];
	
	com_elem_interpoint[2][0] = 1;	com_elem_interpoint[2][1] = 3;	com_elem_interpoint[2][2]=0;	com_elem_interpoint[2][3]=2;
	com_elem_interpoint[2][4] = 1;	com_elem_interpoint[2][5] = 0;	com_elem_interpoint[2][6]=3;	com_elem_interpoint[2][7]=3;
*/	//*********************
