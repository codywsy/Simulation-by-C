...
#define x_size 40	// mono_table size, equal to x+
...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("LCC(31,27)η=1_genius.txt","a"))==NULL)
	{
...
//		printf(" Progress=%0.1f,dectect=%d\r",progress,dectec);
		fp=fopen("LCC(31,27)η=1_genius.txt","a");
...
*/	//*********************
	...
	//i=n-eta
	i=0;
	uncom_elem_interpolation(uncom_elem_interpoint[i][0],uncom_elem_interpoint[i][1],uncom_elem_interpoint[i][2],Q_com_elem,Q_uncom_elem[0],Q_uncom_elem[1]);
