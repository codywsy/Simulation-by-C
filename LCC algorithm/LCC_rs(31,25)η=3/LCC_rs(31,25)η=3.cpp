...
void main()
{
	...
	FILE *fp;
	if((fp=fopen("LCC_rs(31,27)η=3.txt","a"))==NULL)
	{
...
//		printf(" Progress=%0.1f,dectect=%d\r",progress,dectec);
		fp=fopen("LCC_rs(31,27)η=3.txt","a");
	...
	for(i=0;i<2;i++)
		for(u=0;u<2;u++)
			for(v=0;v<2;v++)
			{
				...
				test_vec[j][n-eta+2]=large_vec[v][(int)test_set_ordered[1][n-eta+2]];
				j++;
			}
...
*/	//*********************
	...
	//i=n-eta
	i=0;
	uncom_elem_interpolation(uncom_elem_interpoint[i][0],uncom_elem_interpoint[i][1],uncom_elem_interpoint[i][2],Q_com_elem,Q_uncom_elem[0],Q_uncom_elem[4]);
	
	//i=n-eta+1
	i=1;
	uncom_elem_interpolation(uncom_elem_interpoint[i][0],uncom_elem_interpoint[i][1],uncom_elem_interpoint[i][2],Q_uncom_elem[0],Q_uncom_elem[0],Q_uncom_elem[2]);
	uncom_elem_interpolation(uncom_elem_interpoint[i][0],uncom_elem_interpoint[i][1],uncom_elem_interpoint[i][2],Q_uncom_elem[4],Q_uncom_elem[4],Q_uncom_elem[6]);
	...
	uncom_elem_interpolation(uncom_elem_interpoint[i][0],uncom_elem_interpoint[i][1],uncom_elem_interpoint[i][2],Q_uncom_elem[4],Q_uncom_elem[4],Q_uncom_elem[5]);
	uncom_elem_interpolation(uncom_elem_interpoint[i][0],uncom_elem_interpoint[i][1],uncom_elem_interpoint[i][2],Q_uncom_elem[6],Q_uncom_elem[6],Q_uncom_elem[7]);
