...
#if RamdonMode == 0
#define OpenFile fp=fopen("RS255239_LCC_η=4.txt","a")
#elif RamdonMode == 21
#define OpenFile fp=fopen("RS255239_RPLCC-21_Ω=16.txt","a")
#elif RamdonMode == 22
#define OpenFile fp=fopen("RS255239_RPLCC-22_Ω=16.txt","a")
#elif RamdonMode == 23
#define OpenFile fp=fopen("RS255239_RPLCC-23_Ω=16.txt","a")
#endif
...
#define test_vec_num 2048	//the num of test_vec is 2^(n-k)
...
void main()
{
	...
	for (SNR = start; SNR <= finish; SNR += interval)
	{
		...
		for (j = 1; j <= seq_num; j++)
		{
			...
			//debug: output a (255, 239) Hermitian code
			FILE *fout1;
			...
			*/
			...
			printf("Progress=%0.1f, seqNum=%d, SNR=%2.2f, Bit Errors=%2.1d, BER=%E, Frame Errors=%2.1d, FER=%E, addNum=%0.2f, mulNum=%0.2f, total_num=%0.2f\r", progress, seq_num_Now, SNR, error, BER, ferror, FER, addNum_count, mulNum_count, totalNum_count);
		...
		printf("Progress=%0.1f, seqNum=%d, SNR=%2.2f, Bit Errors=%2.1d, BER=%E, Frame Errors=%2.1d, FER=%E, addNum=%0.2f, mulNum=%0.2f, total_num=%0.2f\n", progress, seq_num_Now, SNR, error, BER, ferror, FER, addNum_count, mulNum_count, totalNum_count);

		OpenFile;
		fprintf(fp, "Progress=%0.1f, seqNum=%d, SNR=%2.2f, Bit Errors=%2.1d, BER=%E, Frame Errors=%2.1d, FER=%E, addNum=%0.2f, mulNum=%0.2f, total_num=%0.2f\n", progress, seq_num_Now, SNR, error, BER, ferror, FER, addNum_count, mulNum_count, totalNum_count);
		fclose(fp);
