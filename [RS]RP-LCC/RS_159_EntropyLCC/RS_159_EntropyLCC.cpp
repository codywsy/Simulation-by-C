...
#if RamdonMode == 0
#define OpenFile fp=fopen("RS159_EntropyLCC_η=4.txt","a")
#elif RamdonMode == 21
#define OpenFile fp=fopen("RS159_RPLCC-21_Ω=16.txt","a")
#elif RamdonMode == 22
#define OpenFile fp=fopen("RS159_RPLCC-22_Ω=16.txt","a")
#elif RamdonMode == 23
#define OpenFile fp=fopen("RS159_EntropyLCC-23_Ω=16.txt","a")
#endif
