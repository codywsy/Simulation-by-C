...
//Method1-2		12
//Method1-3		13
#define RamdonMode 13

#if RamdonMode == 0
#define OpenFile fp=fopen("RS6347_LCC_η=4.txt","a")
#elif RamdonMode == 11
#define OpenFile fp=fopen("RS6347_RPLCC-11_η=4.txt","a")
#elif RamdonMode == 12
#define OpenFile fp=fopen("RS6347_RPLCC-12_η=4.txt","a")
#define fixed_num 1	//can not exceed n-η
#elif RamdonMode == 13
#define OpenFile fp=fopen("RS6347_RPLCC-13_η=4.txt","a")
